...
public class MallSearchServiceImpl implements MallSearchService {
     ...
     * @return
     */
//    private SearchRequest bulidSearchResule(SearchParam paramVo) {
//        //构建DSL语句
...
//    }
     ...
     * @return
     */
    private SearchResult bulidSearchResule(SearchResponse response, SearchParam paramVo) {
...
//        result.setPageNum();
        ...
        if (paramVo.getAttrs() != null && paramVo.getAttrs().size() > 0) {
            List<SearchResult.NavVo> collect = paramVo.getAttrs().stream().map(attr -> {
                ...
                R r = productFeighService.attrInfo(Long.parseLong(s[0]));
