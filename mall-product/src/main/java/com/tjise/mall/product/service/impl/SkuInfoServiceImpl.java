...
public class SkuInfoServiceImpl extends ServiceImpl<SkuInfoDao, SkuInfoEntity> implements SkuInfoService {
    ...
    @Override
    public SkuItemVo item(Long skuId) throws InterruptedException, ExecutionException, TimeoutException {
        ...
        //等待所有任务都完成
        CompletableFuture.allOf(saleAttrFuture, descFuture, baseAttrFuture, imagesFuture).get(5, TimeUnit.SECONDS);
